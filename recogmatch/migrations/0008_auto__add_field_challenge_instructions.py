...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Challenge.instructions'
        db.add_column('recogmatch_challenge', 'instructions',
                      self.gf('django.db.models.fields.TextField')(default=1),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Challenge.instructions'
        db.delete_column('recogmatch_challenge', 'instructions')
