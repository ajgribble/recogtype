...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Challenge.challenge_focus'
        db.alter_column('recogmatch_challenge', 'challenge_focus', self.gf('django.db.models.fields.CharField')(max_length=300))
    def backwards(self, orm):

        # Changing field 'Challenge.challenge_focus'
        db.alter_column('recogmatch_challenge', 'challenge_focus', self.gf('django.db.models.fields.CharField')(max_length=25))
    models = {
        'auth.group': {
