...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Challenge.challenge_focus'
        db.add_column('recogmatch_challenge', 'challenge_focus',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Challenge.challenge_focus'
        db.delete_column('recogmatch_challenge', 'challenge_focus')
    ...
    models = {
        ...
        'recogmatch.challenge': {
            ...
            'challenge_focus': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
