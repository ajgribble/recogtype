...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Challenge.challenge_focus'
        db.alter_column('recogmatch_challenge', 'challenge_focus', self.gf('django.db.models.fields.CharField')(max_length=10))
    models = {
        'auth.group': {
        ...
        'recogmatch.challenge': {
            ...
            'challenge_focus': ('django.db.models.fields.CharField', [], {'max_length': '25'}),
