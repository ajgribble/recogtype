...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RawSample.keyboard'
        db.alter_column('recogmatch_rawsample', 'keyboard', self.gf('django.db.models.fields.CharField')(max_length=50))
    def backwards(self, orm):

        # Changing field 'RawSample.keyboard'
        db.alter_column('recogmatch_rawsample', 'keyboard', self.gf('django.db.models.fields.CharField')(max_length=15))
    models = {
        'auth.group': {
        ...
        'recogmatch.rawsample': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'keyboard': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
