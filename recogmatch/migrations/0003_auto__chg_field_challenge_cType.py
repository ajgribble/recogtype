...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Challenge.cType'
        db.alter_column('recogmatch_challenge', 'cType', self.gf('django.db.models.fields.CharField')(max_length=10))
    def backwards(self, orm):

        # Changing field 'Challenge.cType'
        db.alter_column('recogmatch_challenge', 'cType', self.gf('django.db.models.fields.TextField')())
    models = {
        'auth.group': {
        ...
        'recogmatch.challenge': {
            ...
            'cType': ('django.db.models.fields.CharField', [], {'default': "'f'", 'max_length': '10'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
