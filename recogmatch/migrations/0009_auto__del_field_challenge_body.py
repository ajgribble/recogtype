...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Challenge.body'
        db.delete_column('recogmatch_challenge', 'body')

    def backwards(self, orm):
        # Adding field 'Challenge.body'
        db.add_column('recogmatch_challenge', 'body',
                      self.gf('django.db.models.fields.TextField')(default=datetime.datetime(2012, 7, 24, 0, 0)),
                      keep_default=False)
