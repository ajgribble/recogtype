...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RawSample.os'
        db.add_column('recogmatch_rawsample', 'os',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=25),
                      keep_default=False)

        # Adding field 'RawSample.browser'
        db.add_column('recogmatch_rawsample', 'browser',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=50),
                      keep_default=False)

        # Adding field 'RawSample.keyboard'
        db.add_column('recogmatch_rawsample', 'keyboard',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=15),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'RawSample.os'
        db.delete_column('recogmatch_rawsample', 'os')

        # Deleting field 'RawSample.browser'
        db.delete_column('recogmatch_rawsample', 'browser')

        # Deleting field 'RawSample.keyboard'
        db.delete_column('recogmatch_rawsample', 'keyboard')
    ...
    models = {
        ...
        'recogmatch.challenge': {
            ...
            'challenge_focus': ('django.db.models.fields.CharField', [], {'max_length': '300'}),
        ...
        'recogmatch.rawsample': {
            ...
            'browser': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'keyboard': ('django.db.models.fields.CharField', [], {'max_length': '15'}),
            'os': ('django.db.models.fields.CharField', [], {'max_length': '25'}),
